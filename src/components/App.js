...
export default function App() {
    ...
    const cards = [
        ...
        { question: "Qual é o código para a entrada de visitantes no Ministério da Magia?", answer: "62442. Um segredo: olhe para estes números em um teclado telefônico e verá a palavra MAGIC"},
